...
<body>
    ...
    <!-- Edit Ques -->
    <div id="editQues<?php echo $posting_id ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0">
                <div class="modal-body p-0">
                    <div class="card border-0 p-sm-3 p-2 justify-content-center">
                        ...
                        <div class="card-body px-sm-4 mb-2 pt-1 pb-0">
                            <form action="../../Model/User/updatePosting.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="posting_course" class="form-control" readonly value="<?php echo $row['posting_course']?>" disabled/>
                                </div>
                                <div class="form-group">
